...
def isValidWord(word, hand, wordList):
    ...
    if word in wordList and word != '':
        for i in word:
            if i not in hand or hand[i] < word.count(i):
                return False
        return True
    else: 
        return False
...
def playHand(hand, wordList, n, s):
    """
...
def playGame(wordList):
    ...
    while status != 'e':
        ...
        if status == 'n':
            hand1 = dealHand(n)
            score = playHand(hand1, wordList, n,s)
        elif status == 'r':
            score = playHand(hand1, wordList, n,s)
        elif status not in ['n','r','e']:
